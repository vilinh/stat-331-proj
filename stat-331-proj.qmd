...
did not exist then, and therefore that took care of a lot of the NA values. We pivoted the data to be longer so it can be easily analyzed (on mortality rate and GDP per capita for each year).
